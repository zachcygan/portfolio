                        ...
                        <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
                            ...
                            >
                                <Dialog.Panel className="pointer-events-auto w-screen max-w-2xl">
                                    <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl dark:bg-darkBg">
                                        <div className="px-4 sm:px-6">
                                            <div className="flex items-start justify-between">
                                                ...
                                                <div className="ml-3 flex h-7 items-center">
                                                    <button
                                                        type="button"
                                                        className="relative rounded-md bg-darkBg text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue focus:ring-offset-2"
                                                        onClick={() => handleClose()}
                                                    >
