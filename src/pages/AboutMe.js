...
const features = [
  {
    ...
    description:
      'Video games, new technology, cars, and skiing. I mainly play computer games, but have recently started Breath of the Wild to prepare for Tears of the Kingdom',
    icon: HeartIcon,
  },
  // {
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="lg:ml-auto lg:pl-4 lg:pt-4">
              <div className="lg:max-w-lg">
                ...
                but I enjoy playing other games like Hallow Knight, Diablo, and Elden Ring.
                </p>
