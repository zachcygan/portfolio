...
export default function Resume() {
  return (
    <div className='dark:bg-zinc-800'>
      ...
      <div className=''>
      <iframe className='' title='resume' src="https://docs.google.com/document/d/1TInbdGHe4BT3lxRBPPbxlkb6b2lNGS_7/preview?usp=sharing&ouid=114354419991059278766&rtpof=true&sd=true" width="100%" height="1000" frameborder="0"></iframe>
      </div>
    </div>
  );
}
